...
# Ask to the user the path of the image and the size of his terminal...
...
# If the width is to high, recalculate the height with the terminal width to fit into it...
